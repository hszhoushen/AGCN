...
CUDA_VISIBLE_DEVICES=0 python train_gnn_sr.py --model_type $MODEL_TYPE --epochs $EPOCHS --lr $LR --lri $LRI --test_set_id 1 --atten_type $atten_type --nodes_num $NODES_NUM --fusion True --num_classes 50 --batch_size $BATCH_SIZE  --dataset_name $DATASET_NAME --pretrain >> $LOG_FILE1 &
CUDA_VISIBLE_DEVICES=1 python train_gnn_sr.py --model_type $MODEL_TYPE --epochs $EPOCHS --lr $LR --lri $LRI --test_set_id 2 --atten_type $atten_type --nodes_num $NODES_NUM --fusion True --num_classes 50 --batch_size $BATCH_SIZE  --dataset_name $DATASET_NAME --pretrain >> $LOG_FILE2 &
CUDA_VISIBLE_DEVICES=2 python train_gnn_sr.py --model_type $MODEL_TYPE --epochs $EPOCHS --lr $LR --lri $LRI --test_set_id 3 --atten_type $atten_type --nodes_num $NODES_NUM --fusion True --num_classes 50 --batch_size $BATCH_SIZE  --dataset_name $DATASET_NAME --pretrain >> $LOG_FILE3 &
CUDA_VISIBLE_DEVICES=3 python train_gnn_sr.py --model_type $MODEL_TYPE --epochs $EPOCHS --lr $LR --lri $LRI --test_set_id 4 --atten_type $atten_type --nodes_num $NODES_NUM --fusion True --num_classes 50 --batch_size $BATCH_SIZE  --dataset_name $DATASET_NAME --pretrain >> $LOG_FILE4 &
CUDA_VISIBLE_DEVICES=4 python train_gnn_sr.py --model_type $MODEL_TYPE --epochs $EPOCHS --lr $LR --lri $LRI --test_set_id 5 --atten_type $atten_type --nodes_num $NODES_NUM --fusion True --num_classes 50 --batch_size $BATCH_SIZE  --dataset_name $DATASET_NAME --pretrain >> $LOG_FILE5 &
