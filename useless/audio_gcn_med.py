...
def net_train(args, audio_net, audio_gcn_model, audio_classifier, data_loader, optimizer, epoch):
    ...
    for i, data in enumerate(data_loader, 0):
        ...
        if (args.fusion == False):
            resnet_output, feat8, feat16, feat32 = audio_net(audio)
            # print('feat8:', feat8.shape)      ([16, 512, 51, 16])
            # print('feat16:', feat16.shape)    ([16, 1024, 26, 8])
            # print('feat32:', feat32.shape)    ([16, 2048, 13, 4])
            # print('resnet_output:', resnet_output.shape)  ([16, 1, 201, 64])

            gcn_output = audio_gcn_model(feat16)
