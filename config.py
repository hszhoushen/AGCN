...
_C.MODEL.backbone_networks = ['resnet18', 'resnet50', 'resnet101', 'vgg16', 'mobilenet_v2', 'densenet121']
_C.MODEL.borm_backbone_networks = ['resnet18_borm_gdconv', 'resnet50_borm_gdconv', 'resnet101_borm_gdconv',
                                   'vgg16_borm_gdconv', 'mobilenet_v2_borm_gdconv', 'densenet121_borm_gdconv']
