...
class arguments_parse(object):
    def argsParser():
        ...
        parser.add_argument('-b', '--bs', default=BATCH_SIZE, type=int,
        ...
        parser.add_argument('--model_type', type=str, default='audio_gcn',
                            help='choose the type of object model')
        parser.add_argument('--atten_type', type=str, default='afm',
        ...
        parser.add_argument('--experiment_id', type=int, default=5, help='test set id 5')
